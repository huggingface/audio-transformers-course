...
![The transformer with audio input and output](../../../assets/img/transformers_blocks.png)

For audio tasks, the input and/or output sequences may be audio instead of text:

- Automatic speech recognition (ASR): The input is a speech waveform, the output is text.
...
![Wav2Vec2 uses a CNN to create embeddings from the input waveform](../../../assets/img/wav2vec2-input.png)
...
The transformer architecture outputs a sequence of embeddings vectors. Our goal is to transform these embedding vectors into a text or audio output.
...
![SpeechT5 outputs a spectrogram and uses a vocoder to create the waveform](../../../assets/img/speecht5.png)
