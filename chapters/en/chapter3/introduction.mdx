...
<div class="flex justify-center">
    <img src="https://huggingface.co/datasets/huggingface-course/audio-course-images/resolve/main/wav2vec2-input.png" height="50%" alt="Wav2Vec2 uses a CNN to create embeddings from the input waveform">
</div>
