...
Currently, MMS model is being actively integrated in 🤗 Transformers. To try it out, you need to install the library from source

```bash
pip install git+https://github.com/huggingface/transformers.git
```

Let's give it a go, and see how we can synthesize speech in a language other than English, e.g. German. 
