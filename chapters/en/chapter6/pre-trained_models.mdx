...
Bark is very versatile and can generate audio conditioned by [a speaker embeddings library] (https://suno-ai.notion.site/8b8e8749ed514b0cbf3f699013548683?v=bc67cff786b04b50b3ceb756fd05f68c), which you can listen to here, and which can be loaded via the processor.
