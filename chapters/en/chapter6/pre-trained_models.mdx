...
```python
inputs = processor("[clears throat] This is a test ... and I just took a long pause.", voice_preset="v2/fr_speaker_1")
...
```python
inputs = processor("♪ In the mighty jungle, I'm trying to generate barks.", voice_preset="v2/fr_speaker_1")
