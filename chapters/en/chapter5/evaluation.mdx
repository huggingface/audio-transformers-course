...
TODO(SG): sub-section on post-processing to normalise text before computing metrics (strip punctuation and casing)

## Putting it all together

TODO(SG): zero-shot evaluation of Whisper-small on CV13 Dhivehi test set using pipeline, with WER calculation
