...
as little of 10 hours of additional data, we can improve the performance of the Whisper model by X% on a low-resource
language. TODO(SG): update with results when available. In the next section, we'll cover the process behind selecting a
