...
**Output:**
```
[{'score': 0.8167386054992676, 'label': 'up'},
 {'score': 0.16170723736286163, 'label': '_unknown_'},
 {'score': 0.013553570955991745, 'label': 'right'},
 {'score': 0.005410837009549141, 'label': 'go'},
 {'score': 0.0021237542387098074, 'label': 'left'}]
```

Cool! Looks like the example contains the word "up" with high probability (81.7%).
