...
If you face error in running above code please modify following 

batch_size: defaults to 1000, reduce it to 100, and if that doesn't work then reduce it by a factor of 2 again to 50
writer_batch_size: defaults to 1000, reduce it to 500, and if that doesn't work then reduce it by a factor of 2 to 250
</Tip>
