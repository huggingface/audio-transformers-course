...
Welcome to the second unit of the Hugging Face audio course! In the previous unit, we explored the fundamentals of audio data
...
At this point you may be eager to learn about the audio tasks that 🤗 Transformers can handle, and you have all the foundational
...
**Speaker diarization**: Ever wondered who's speaking in a recording? With 🤗 Transformers, you can identify which speaker
...
**Automotive speaker verification**: How cool is it to verify whether the speaker of a pair of utterances is the same?
With 🤗 Transformers, you can easily do that!
