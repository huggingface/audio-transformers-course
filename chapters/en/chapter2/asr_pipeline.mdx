...
To get started, load the datas  et and upsample it to 16kHz as described in [Audio classification with a pipeline](audio_applications.mdx),
...
Find a pre-trained ASR model for German language on hub, instantiate a pipeline, and transcribe the example:
