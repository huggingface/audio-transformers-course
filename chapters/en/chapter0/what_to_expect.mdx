...
The course is structured into several units, each of which covers a specific topic in depth:
...
* Unit 5: delve into speech recognition and build a train a model to transcribe meeting recordings.
...
By the end of the course, you will have a strong foundation in using transformers for audio data and be
