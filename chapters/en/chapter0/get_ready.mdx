# Get ready to take the course [testing]
...
<!-- Hard-to-miss button with link to the signup page -->
...
<!-- Hard-to-miss button with link to https://huggingface.co/join -->
...
<!-- Hard-to-miss button with link to https://discord.gg/ydHrjt3WP5 -->
